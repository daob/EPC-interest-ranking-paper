...
These approaches treat the choices as perfectly measured; however, rankings may contain measurement error, so that latent variable models become necessary. %For example, a respondent's high priority for ``protecting freedom of speech'' may not be a perfect measure of their postmaterialism. 
...
Thus, measurement differences may, but need not, contaminate conclusions about both mean differences and relationships between variables.
